...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $selectedRole = mysqli_real_escape_string($koneksi, $_POST["role"]);

    // Insert the new user into the database with the specified role
    $insertQuery = "INSERT INTO users (username, password, email, namaLengkap, alamat, role) VALUES ('$username', '$hashedPassword', '$email', '$NL', '$alamat', '$selectedRole')";
