...
--
-- Host: localhost:3306
-- Waktu pembuatan: 19 Jan 2024 pada 22.21
...
--
ALTER TABLE `buku`
  MODIFY `bukuID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `kategoriBuku`
--
ALTER TABLE `kategoriBuku`
  MODIFY `kategoriID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
